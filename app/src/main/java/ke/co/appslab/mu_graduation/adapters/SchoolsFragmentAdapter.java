 ...
 */
public class SchoolsFragmentAdapter  extends RecyclerView.Adapter<SchoolsFragmentAdapter.ContactViewHolder>{
    ...
    public SchoolsFragmentAdapter(List<ContactInfo> contactList) {
