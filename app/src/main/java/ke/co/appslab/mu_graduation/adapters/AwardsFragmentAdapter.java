 ...
 */
public class AwardsFragmentAdapter extends RecyclerView.Adapter<AwardsFragmentAdapter.ContactViewHolder> {
    private List<ContactInfo> contactList;
    private Context mContext;


    //pass the contact array into the constructor
    public AwardsFragmentAdapter(List<ContactInfo> contactList) {
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.awards_recyclerview, viewGroup, false);
